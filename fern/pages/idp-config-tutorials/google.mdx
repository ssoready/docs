...
Starting from the Google Workspace admin page, i.e. [admin.google.com](admin.google.com), navigate to *Apps* > *Web and mobile apps* in the left navigation bar. This link will send you to a new page.
