...
If you're using NextAuth.js, you'll need to make the following change to your NextAuth setup:
...
```text
http://localhost:3000/api/auth/callback/ssoready
```

or

```text
https://yourapp.com/api/auth/callback/ssoready
```
...
use in ["Handling SAML Logins"](#handling-saml-logins).
...
Logins"](#initiating-saml-logins) and in ["Handling SAML Logins"](#handling-saml-logins).
