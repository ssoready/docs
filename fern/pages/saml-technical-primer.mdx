...
Your users probably don't know what SAML is. But they love what it gives them: a
one-click login experience for every SaaS tool they use at work.

Okta is a very popular identity provider. When your user opens their computer at
work in the morning, here's what they see:

<Frame caption="A screenshot of Okta. Every app is a 'tile'. Click on a tile, and you're now logged into it.">
    <img src="okta-tiles-screenshot.jpg" alt="" />
</Frame>

At work, your customers 
