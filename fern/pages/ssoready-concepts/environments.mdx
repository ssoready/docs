...
2. Programmatically, using the [Management API](/docs/api-reference/management)
...
<Note>
The management API is only available on the [Pro
tier](https://ssoready.com/pricing) or above when using the SSOReady's
...
For more details, see the [Management API reference
documentation](/docs/api-reference/management).
